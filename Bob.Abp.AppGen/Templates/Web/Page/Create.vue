...
<form asp-page="/{{LastEntityGroup.RelativePath}}/{{EntityName}}/CreateModal">
    <abp-modal size="Large">
        <abp-modal-header title="@L["New{{EntityName}}"].Value"></abp-modal-header>
            ...
            {{#UiTabs}}
                ...
                <abp-tab title="@L["DisplayName:{{Title}}"].Value">
                   ...
                   {{#IsBasic}}
                        {{#Properties}}
                            {{#IsCreateField}}
                        <abp-{{^IsEnum}}input{{/IsEnum}}{{#IsEnum}}selct{{/IsEnum}} asp-for="{{EntityName}}.{{PropertyName}}" />
                            {{/IsCreateField}}
                        {{/Properties}}
                   {{/IsBasic}}
                   {{#IsMultiSelect}}
